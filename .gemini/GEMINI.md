# Gemini Instructions - live-whisper

This project follows the **[AGENTS.md](../AGENTS.md)** workflow.
...
- **Patterns:** [docs/implementation-reference.md](../docs/implementation-reference.md)
